...
export function WithdrawFormComponent({ onSuccess }: { onSuccess: () => void }) {
  ...
  return (
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div className="border rounded-lg p-3 bg-red-50 dark:bg-red-950/20">
        <h3 className="font-semibold text-sm mb-3 text-red-700 dark:text-red-400">Withdrawal Details</h3>
        <div className="space-y-3">
          <div>
            <Label htmlFor="amount">Withdrawing</Label>
